...
public class DownloaderApp extends Application {
    ...
    private Parent createContent() {
        ...
        fieldURL.setOnAction(event -> {
            ...
            Label urlName = new Label("-");
            urlName.setText(fieldURL.getText());
    ...
    private class DownloadTask extends Task<Void> {
        ...
        protected Void call() throws Exception {
            ...
            try (InputStream is = connection.getInputStream();
                 OutputStream os = Files.newOutputStream(Paths.get(parts[parts.length - 1]))) {
